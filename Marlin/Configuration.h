...
#define STRING_CONFIG_H_AUTHOR "(Bas Spaans, Mendel90 config)" // Who made the changes.
...
#define MANUAL_Z_HOME_POS (204.8)
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,200*16/1,534.95}  // default steps per unit for ultimaker 
